...
- **406: Address Will Predictably Timeout** - The API returns this error on addresses which have too many transactions. As a result such addresses have been blacklisted to prevent traffic on the servers.
