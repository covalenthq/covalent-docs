...
[Covalent](https://www.covalenthq.com/?utm_source=astar&utm_medium=partner-docs) provides a unified API to bring full transparency and visibility to assets across all blockchains including Astar's Mainnet and Testnet.
...
| **Networks & `chain_id`** | Mainnet - `592`|
| **Supported Endpoints** | **Class A Universal** <br>- [Balances](https://www.covalenthq.com/docs/api/#/0/Get%20token%20balances%20for%20address/USD/592) <br> - [Transactions](https://www.covalenthq.com/docs/api/#/0/Get%20transactions%20for%20address/USD/592) <br> - [Transfers](https://www.covalenthq.com/docs/api/#/0/Get%20ERC20%20token%20transfers%20for%20address/USD/592) <br> - [Token Holders](https://www.covalenthq.com/docs/api/#/0/Get%20token%20holders%20as%20of%20any%20block%20height/USD/592) <br> - [Log Events (Contract Address)](https://www.covalenthq.com/docs/api/#/0/Get%20log%20events%20by%20contract%20address/USD/592) <br> - [Log Events (Topic Hash)](https://www.covalenthq.com/docs/api/#/0/Get%20log%20events%20by%20topic%20hash(es)/USD/592)
...
const astarChainId = '592'
const demoAddress = '0xc0043Ad81De6DB53a604e42377290EcfD4Bc5fED'
...
getWalletBalance(AstarChainId, demoAddress);
```
...
astar_chain_id = '592'
demo_address = '0xc0043Ad81De6DB53a604e42377290EcfD4Bc5fED'
...
# Example address request
get_wallet_balance(astar_chain_id, demo_address)
```
...
Check out our collection of ready-to-ship [**Code Templates**](https://covalenthq.notion.site/dbf062042f4a463a950f0047b9df9ec1?v=2f7a0d7267034526a641ce7215dd7512/?utm_source=Astar&utm_medium=partner-docs) you can use immediately to build Web3 data-powered dApps.
